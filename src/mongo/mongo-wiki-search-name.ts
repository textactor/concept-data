...
export class MongoWikiSearchName extends MongoItem<WikiSearchName> {
  ...
  protected override beforeCreate(data: WikiSearchName) {
    (<any>data)[EXPIRES_AT_FIELD] = new Date(data.expiresAt * 1000);

    return super.beforeCreate(data);
  }

  protected override beforeUpdate(data: RepositoryUpdateData<WikiSearchName>) {
    data.set = data.set || {};
  ...
  protected override convertFromMongoDoc(doc: any): WikiSearchName {
