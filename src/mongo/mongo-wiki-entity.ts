...
export class MongoWikiEntity extends MongoItem<WikiEntity> {
  ...
  protected override beforeCreate(data: WikiEntity) {
    (<any>data)[EXPIRES_AT_FIELD] = new Date(data.expiresAt * 1000);

    return super.beforeCreate(data);
  }

  protected override beforeUpdate(data: RepositoryUpdateData<WikiEntity>) {
    data.set = data.set || {};
  ...
  protected override convertFromMongoDoc(doc: any): WikiEntity {
